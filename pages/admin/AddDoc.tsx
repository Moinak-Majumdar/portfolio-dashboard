          ...
          <form onSubmit={handelSubmit} className='md:p-2 mt-8 mx-auto grid grid-cols-4 2xl:grid-cols-8 gap-4'>
            ...
            <div className='col-span-4 md:col-span-2 flex flex-col'>
              ...
              <div className='flex mt-2 gap-6'>
                <span>
                  <input id='client-work' value='work' onChange={() => setData({ ...data, type: 'work' })} name='type' required={true} type="radio" disabled={disable} />
                ...
                <span>
                  <input id='personal-project' value='project' onChange={() => setData({ ...data, type: 'project' })} name='type' required={true} type="radio" disabled={disable} />
            ...
            <div className='col-span-4 md:col-span-2 flex flex-col'>
              ...
              <div className='flex mt-2 gap-6'>
                <span>
                  <input id='status-done' value='completed' onChange={() => setData({ ...data, status: 'completed' })} name='status' required={true} type="radio" disabled={disable} />
                ...
                <span>
                  <input id='status-running' value='under development' onChange={() => setData({ ...data, status: 'under development' })} name='status' required={true} type="radio" disabled={disable} />
