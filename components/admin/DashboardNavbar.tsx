...
const DashboardNavbar = () => {
  ...
  return (
    <>
      <section className='fixed top-[10px] left-0 md:left-2 flex justify-center items-center p-[6px] bg-gradient-to-br via-violet-800 from-indigo-800 to-slate-900 rounded-full z-40'>
